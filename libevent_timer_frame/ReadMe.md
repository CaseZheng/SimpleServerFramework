...
# 请求示例
```
[CaseZheng@VM_187_252_centos example]$ curl -d '{"_head":{"_interface":"test","_timestamps":"12345678","_invokeId":"123456","_version":"1.0.1","_callerServerId":"9999"},"_params":{}}' http://127.0.0.1:9999/example
